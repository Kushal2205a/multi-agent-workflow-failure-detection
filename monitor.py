...
STATUS_REGEX = re.compile(
    r"\*{0,2}_{0,2}`?(?:OVERALL )?STATUS\*{0,2}_{0,2}`?:?\s*(?:\*{0,2}_{0,2}`?\s*)*(APPROVED|CHANGES_REQUIRED|REQUIRES_IMPROVEMENT|REQUIRES IMPROVEMENT|MINOR_ISSUES|MINOR|PENDING|REJECTED?|REJECT)",
    re.IGNORECASE,
)
